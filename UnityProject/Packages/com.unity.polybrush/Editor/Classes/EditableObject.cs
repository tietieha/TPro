...
namespace UnityEditor.Polybrush
{
    ...
    class EditableObject : IEquatable<EditableObject>, IValid
	{
        ...
        private void Initialize(GameObject go)
        {
            ...
            if (polybrushMesh.mode == PolybrushMesh.Mode.Mesh)
            {
                mesh = originalMesh;
            }
            else
        ...
        internal void Revert()
		{
            ...
            if (graphicsMesh != null && graphicsMesh != originalMesh)
                GameObject.DestroyImmediate(graphicsMesh);

            if (m_PolybrushMesh != null)
                PrefabUtility.RecordPrefabInstancePropertyModifications(m_PolybrushMesh);
        }
        ...
        {
            if (isProBuilderObject || m_PolybrushMesh.mode == PolybrushMesh.Mode.Mesh)
            {
