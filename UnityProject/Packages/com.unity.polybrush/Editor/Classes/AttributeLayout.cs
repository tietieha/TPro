...
namespace UnityEngine.Polybrush
{
	...
	internal class AttributeLayout : IEquatable<AttributeLayout>
	{
        ...
        // is Control Texture
        [SerializeField] internal bool isControlTexture = false;

        // Which tex to apply values to (color)
        [SerializeField] internal int texIndex;
		...
		internal AttributeLayout(MeshChannel channel, ComponentIndex index, Vector2 range, int mask, bool isBaseTexture = false, bool isControlTexture = false, int texIndex = 0)
		{
            ...
            this.isControlTexture = isControlTexture;
		...
		public bool Equals(AttributeLayout other)
		{
			return 	channel == other.channel &&
                    ...
                    isControlTexture == other.isControlTexture &&
