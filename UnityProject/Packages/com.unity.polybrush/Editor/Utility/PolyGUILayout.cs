...
namespace UnityEditor.Polybrush
{
    ...
    internal static class PolyGUILayout
	{
        ...
        internal static int AspectSelectionGrid(int selected, Texture2D[] textures, int approxSize, GUIStyle style,
            string emptyString, out bool doubleClick)
        {
            ...
            if (textures != null)
            {
                if (textures.Length != 0)
                {
                    ...
                    int num3 = Mathf.CeilToInt((float) textures.Length / num2);
