...
namespace UnityEditor.Rendering.Universal.ShaderGUI
{
    ...
    public static class LitGUI
    {
        ...
        public struct LitProperties
        {
            ...
            /// <summary>
            /// The MaterialProperty for roughness value.
            /// </summary>
        ...
        public static void SetMaterialKeywords(Material material)
        {
            ...
            if (material.HasProperty(specularGlossMap))
				CoreUtils.SetKeyword(material, "_METALLICSPECGLOSSMAP", material.GetTexture(specularGlossMap) != null);
