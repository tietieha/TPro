...
using Platform = UnityEditor.ShaderGraph.Platform;
...
namespace UnityEditor.Rendering.Universal.ShaderGraph
{
    ...
    static class CorePragmas
    {
        ...
        {
            { Pragma.Target(ShaderModel.Target20) },
            { Pragma.ExcludeRenderers(new[] { UnityEditor.ShaderGraph.Platform.D3D9 }) },
            { Pragma.Vertex("vert") },
            { Pragma.Fragment("frag") },
        };
        ...
        public static readonly PragmaCollection GBuffer = new PragmaCollection
        {
            ...
            { Pragma.ExcludeRenderers(new[] { UnityEditor.ShaderGraph.Platform.GLES, UnityEditor.ShaderGraph.Platform.GLES3, UnityEditor.ShaderGraph.Platform.GLCore }) },
            { Pragma.MultiCompileInstancing },
            { Pragma.MultiCompileFog },
            { Pragma.InstancingOptions(InstancingOptions.RenderingLayer) },
            { Pragma.Vertex("vert") },
