...
namespace TEngine
{
    ...
    public class AudioModule : Module
    {
        ...
        /// <param name="bAsync">是否异步加载</param>
        /// <param name="bInPool">是否支持资源池</param>
        public AudioAgent Play(int type, string path, bool bLoop = false, float volume = 1.0f, bool bAsync = false, bool bInPool = false)
        {
            return AudioModuleImp.Play((AudioType)type, path, bLoop, volume, bAsync, bInPool);
        }
