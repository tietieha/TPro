...
namespace TEngine
{
    ...
    public sealed class RootModule : Module
    {
        ...
        [SerializeField]
        private ThreadPriority m_BackgroundLoadingPriority = ThreadPriority.BelowNormal;
        ...
        protected override void Awake()
        {
            ...
            Log.Info("localMachineName: {0}", Dns.GetHostName());
            // Log.Info("deviceName: {0}", SystemInfo.deviceName);
            Log.Info("Game Version: {0}", Version.GameVersion);
