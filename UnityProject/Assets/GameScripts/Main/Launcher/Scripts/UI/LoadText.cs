...
namespace GameMain
{
    public class TextMode
    {
        ...
        public string Label_DownLoadFailed = "下载失败";
    ...
    public class LoadText : TextMode
    {
        ...
        public void InitConfigData(TextAsset asset)
        {
            ...
            if (loadConfig != null)
            {
                ...
                Label_Storage_Low_Load = loadConfig.Label_Storage_Low_Load;
