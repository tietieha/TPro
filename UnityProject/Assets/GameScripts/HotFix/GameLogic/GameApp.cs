...
public partial class GameApp : Singleton<GameApp>
{
    ...
    public static void Entrance(object[] objects)
    {
        ...
        Log.Debug("======= 看到此条日志代表你成功运行了热更新代码 呜呼 =======");
        Log.Info("======= Entrance GameApp =======");
        Instance.Active();
        Instance.Start();
        ...
        Utility.Unity.AddOnApplicationFocusListener(Instance.OnApplicationFocus);
    ...
    public static void Shutdown(ShutdownType shutdownType)
    {
        ...
        if (shutdownType == ShutdownType.Restart)
        {
            ...
            Utility.Unity.RemoveOnApplicationFocusListener(Instance.OnApplicationFocus);
            Utility.Unity.RemoveOnApplicationQuitListener(Instance.OnApplicationQuit);
        }
