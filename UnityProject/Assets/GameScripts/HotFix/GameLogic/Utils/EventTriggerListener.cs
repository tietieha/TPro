...
public class EventTriggerListener : EventTrigger
{
    ...
    public PointerEventDataDelegate onBeginDragPoint;
    public PointerEventDataDelegate onDragPoint;
    public PointerEventDataDelegate onEndDragPoint;
    ...
    public bool ClickCheck { get => clickCheck; set => clickCheck = value; }
    ...
    {
        if (m_Interactable && onDragPoint != null) onDragPoint(gameObject, eventData);
    }
    public void OnBeginDragPoint(PointerEventData eventData)
    {
        if (m_Interactable && onBeginDragPoint != null) onBeginDragPoint(gameObject, eventData);
    }
    public void OnEndDragPoint(PointerEventData eventData)
    {
        if (m_Interactable && onEndDragPoint != null) onEndDragPoint(gameObject, eventData);
    }
