...
namespace Priority_Queue
{
    ...
    /// </summary>
    /// <typeparam name="TItem">The type to enqueue</typeparam>
    public class SimplePriorityQueue<TItem> : SimplePriorityQueue<TItem, int>
    {
        /// <summary>
        /// Instantiate a new Priority Queue
        /// </summary>
        ...
        public SimplePriorityQueue(IComparer<int> comparer) : base(comparer) { }

        /// <summary>
        /// Instantiate a new Priority Queue
        /// </summary>
        /// <param name="comparer">The comparison function to use to compare priority values</param>
        public SimplePriorityQueue(Comparison<int> comparer) : base(comparer) { }
    }
}