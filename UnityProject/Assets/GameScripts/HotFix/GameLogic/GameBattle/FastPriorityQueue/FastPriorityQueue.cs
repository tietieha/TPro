...
namespace Priority_Queue
{
    ...
    public sealed class FastPriorityQueue<T> : IFixedSizePriorityQueue<T, long>
        where T : FastPriorityQueueNode
    {
        ...
        public FastPriorityQueue(long maxNodes)
        {
#if DEBUG
            if (maxNodes <= 0)
            {
        ...
        /// O(n)
        /// </summary>
        public void Resize(long maxNodes)
        {
#if DEBUG
            if (maxNodes <= 0)
            {
            ...
            long highestIndexToCopy = Math.Min(maxNodes, _numNodes);
