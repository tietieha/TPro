...
namespace UnityEngine.UI.Extensions
{
    ...
    /// <summary>
    /// 备注：用这个插件时 Viewpot 和 scrollview 大小一定要一致！！！！！！
    /// 不然如果不是循环列表 最后一页会抖动！！！！！！
    /// </summary>
    ...
    public class HorizontalScrollSnap : ScrollSnapBase
    {
        void Start()
        {
            ...
            // 不需要start的时候，updateLayout，不应该有预制中写死的cell，都应该走动态创建
            // UpdateLayout();
        }
        ...
        private void SetScrollContainerPosition()
        {
            ...
            if (_screens != 1) _scroll_rect.horizontalNormalizedPosition = (float)(_currentPage) / (_screens - 1);
        ...
        // private bool _hasEnable = false;
        private void OnEnable()
        {
            if (_hasEnable && DontAllowReOnEnable)
            {
                return;
            }
