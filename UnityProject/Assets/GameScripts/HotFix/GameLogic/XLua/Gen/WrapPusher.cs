...
namespace XLua
{
    public partial class ObjectTranslator
    {
        ...
        class IniterAdderUnityEngineVector2
        {
			...
			static void Init(LuaEnv luaenv, ObjectTranslator translator)
			{
				...
				translator.RegisterPushAndGetAndUpdate<EventId>(translator.PushEventId, translator.Get, translator.UpdateEventId);
				translator.RegisterPushAndGetAndUpdate<EmbattleCellColorType>(translator.PushEmbattleCellColorType, translator.Get, translator.UpdateEmbattleCellColorType);
				translator.RegisterPushAndGetAndUpdate<M.PathFinding.EUnitType>(translator.PushMPathFindingEUnitType, translator.Get, translator.UpdateMPathFindingEUnitType);
				translator.RegisterPushAndGetAndUpdate<M.PathFinding.EUnitState>(translator.PushMPathFindingEUnitState, translator.Get, translator.UpdateMPathFindingEUnitState);
        ...
        int EventId_TypeID = -1;
		int EventId_EnumRef = -1;
        
        public void PushEventId(RealStatePtr L, EventId val)
        {
            if (EventId_TypeID == -1)
            {
			    bool is_first;
                EventId_TypeID = getTypeId(L, typeof(EventId), out is_first);
				
				if (EventId_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(EventId));
				    EventId_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, EventId_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, EventId_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for EventId ,value="+val);
            }
			
			LuaAPI.lua_getref(L, EventId_EnumRef);
			LuaAPI.lua_pushvalue(L, -2);
			LuaAPI.xlua_rawseti(L, -2, (int)val);
			LuaAPI.lua_pop(L, 1);
        ...
        public void Get(RealStatePtr L, int index, out EventId val)
        {
            ...
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != EventId_TypeID)
				{
				    throw new Exception("invalid userdata for EventId");
				}
                ...
                if (!CopyByValue.UnPack(buff, 0, out e))
                {
                    throw new Exception("unpack fail for EventId");
                }
				val = (EventId)e;
            ...
            {
                val = (EventId)objectCasters.GetCaster(typeof(EventId))(L, index, null);
            }
        }
		
        public void UpdateEventId(RealStatePtr L, int index, EventId val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for EventId ,value="+val);
                }
            }
        ...
        int EmbattleCellColorType_TypeID = -1;
		int EmbattleCellColorType_EnumRef = -1;
        
        public void PushEmbattleCellColorType(RealStatePtr L, EmbattleCellColorType val)
        {
            if (EmbattleCellColorType_TypeID == -1)
            {
			    bool is_first;
                EmbattleCellColorType_TypeID = getTypeId(L, typeof(EmbattleCellColorType), out is_first);
				
				if (EmbattleCellColorType_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(EmbattleCellColorType));
				    EmbattleCellColorType_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, EmbattleCellColorType_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, EmbattleCellColorType_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for EmbattleCellColorType ,value="+val);
            }
			
			LuaAPI.lua_getref(L, EmbattleCellColorType_EnumRef);
			LuaAPI.lua_pushvalue(L, -2);
			LuaAPI.xlua_rawseti(L, -2, (int)val);
			LuaAPI.lua_pop(L, 1);
        ...
        public void Get(RealStatePtr L, int index, out EmbattleCellColorType val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != EmbattleCellColorType_TypeID)
				{
				    throw new Exception("invalid userdata for EmbattleCellColorType");
				}
                ...
                if (!CopyByValue.UnPack(buff, 0, out e))
                {
                    throw new Exception("unpack fail for EmbattleCellColorType");
                }
				val = (EmbattleCellColorType)e;
                
            }
            else
            {
                val = (EmbattleCellColorType)objectCasters.GetCaster(typeof(EmbattleCellColorType))(L, index, null);
            }
        }
		
        public void UpdateEmbattleCellColorType(RealStatePtr L, int index, EmbattleCellColorType val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for EmbattleCellColorType ,value="+val);
                }
            }
        ...
        int MPathFindingEUnitType_TypeID = -1;
		int MPathFindingEUnitType_EnumRef = -1;
        
        public void PushMPathFindingEUnitType(RealStatePtr L, M.PathFinding.EUnitType val)
        {
            if (MPathFindingEUnitType_TypeID == -1)
            {
			    bool is_first;
                MPathFindingEUnitType_TypeID = getTypeId(L, typeof(M.PathFinding.EUnitType), out is_first);
				
				if (MPathFindingEUnitType_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(M.PathFinding.EUnitType));
				    MPathFindingEUnitType_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, MPathFindingEUnitType_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, MPathFindingEUnitType_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for M.PathFinding.EUnitType ,value="+val);
            }
			
			LuaAPI.lua_getref(L, MPathFindingEUnitType_EnumRef);
			LuaAPI.lua_pushvalue(L, -2);
			LuaAPI.xlua_rawseti(L, -2, (int)val);
			LuaAPI.lua_pop(L, 1);
        ...
        public void Get(RealStatePtr L, int index, out M.PathFinding.EUnitType val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != MPathFindingEUnitType_TypeID)
				{
				    throw new Exception("invalid userdata for M.PathFinding.EUnitType");
				}
                ...
                if (!CopyByValue.UnPack(buff, 0, out e))
                {
                    throw new Exception("unpack fail for M.PathFinding.EUnitType");
                }
				val = (M.PathFinding.EUnitType)e;
                
            }
            else
            {
                val = (M.PathFinding.EUnitType)objectCasters.GetCaster(typeof(M.PathFinding.EUnitType))(L, index, null);
            }
        }
		
        public void UpdateMPathFindingEUnitType(RealStatePtr L, int index, M.PathFinding.EUnitType val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for M.PathFinding.EUnitType ,value="+val);
                }
            }
        ...
        int MPathFindingEUnitState_TypeID = -1;
		int MPathFindingEUnitState_EnumRef = -1;
        
        public void PushMPathFindingEUnitState(RealStatePtr L, M.PathFinding.EUnitState val)
        {
            if (MPathFindingEUnitState_TypeID == -1)
            {
			    bool is_first;
                MPathFindingEUnitState_TypeID = getTypeId(L, typeof(M.PathFinding.EUnitState), out is_first);
				
				if (MPathFindingEUnitState_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(M.PathFinding.EUnitState));
				    MPathFindingEUnitState_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, MPathFindingEUnitState_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, MPathFindingEUnitState_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for M.PathFinding.EUnitState ,value="+val);
            }
			
			LuaAPI.lua_getref(L, MPathFindingEUnitState_EnumRef);
			LuaAPI.lua_pushvalue(L, -2);
			LuaAPI.xlua_rawseti(L, -2, (int)val);
			LuaAPI.lua_pop(L, 1);
        ...
        public void Get(RealStatePtr L, int index, out M.PathFinding.EUnitState val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != MPathFindingEUnitState_TypeID)
				{
				    throw new Exception("invalid userdata for M.PathFinding.EUnitState");
				}
                ...
                if (!CopyByValue.UnPack(buff, 0, out e))
                {
                    throw new Exception("unpack fail for M.PathFinding.EUnitState");
                }
				val = (M.PathFinding.EUnitState)e;
                
            }
            else
            {
                val = (M.PathFinding.EUnitState)objectCasters.GetCaster(typeof(M.PathFinding.EUnitState))(L, index, null);
            }
        }
		
        public void UpdateMPathFindingEUnitState(RealStatePtr L, int index, M.PathFinding.EUnitState val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for M.PathFinding.EUnitState ,value="+val);
                }
            }
	...
	public partial class StaticLuaCallbacks
    {
	    internal static bool __tryArrayGet(Type type, RealStatePtr L, ObjectTranslator translator, object obj, int index)
		{
			...
			else if (type == typeof(EventId[]))
			{
			    EventId[] array = obj as EventId[];
				translator.PushEventId(L, array[index]);
				return true;
			}
			else if (type == typeof(EmbattleCellColorType[]))
			{
			    EmbattleCellColorType[] array = obj as EmbattleCellColorType[];
				translator.PushEmbattleCellColorType(L, array[index]);
				return true;
			}
			else if (type == typeof(M.PathFinding.EUnitType[]))
			{
			    M.PathFinding.EUnitType[] array = obj as M.PathFinding.EUnitType[];
				translator.PushMPathFindingEUnitType(L, array[index]);
				return true;
			}
			else if (type == typeof(M.PathFinding.EUnitState[]))
			{
			    M.PathFinding.EUnitState[] array = obj as M.PathFinding.EUnitState[];
				translator.PushMPathFindingEUnitState(L, array[index]);
				return true;
			}
            return false;
		}
