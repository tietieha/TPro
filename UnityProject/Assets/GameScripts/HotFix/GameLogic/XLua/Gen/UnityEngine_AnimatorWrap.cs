...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAnimatorWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 55, 45, 20);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "avatarRoot", _g_get_avatarRoot);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_avatarRoot(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.Animator gen_to_be_invoked = (UnityEngine.Animator)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.avatarRoot);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
