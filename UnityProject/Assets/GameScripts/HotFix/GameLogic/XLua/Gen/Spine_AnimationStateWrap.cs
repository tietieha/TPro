...
namespace XLua.CSObjectWrap
{
    ...
    public class SpineAnimationStateWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 21, 3, 2);
			
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "AssignEventSubscribersFrom", _m_AssignEventSubscribersFrom);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "AddEventSubscribersFrom", _m_AddEventSubscribersFrom);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Update", _m_Update);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Apply", _m_Apply);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ApplyEventTimelinesOnly", _m_ApplyEventTimelinesOnly);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ClearListenerNotifications", _m_ClearListenerNotifications);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Spine.AnimationStateData>(L, 2))
				{
					...
					var gen_ret = new Spine.AnimationState(_data);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_AssignEventSubscribersFrom(RealStatePtr L)
        {
		    try {
                ...
                {
                    Spine.AnimationState _src = (Spine.AnimationState)translator.GetObject(L, 2, typeof(Spine.AnimationState));
                    
                    gen_to_be_invoked.AssignEventSubscribersFrom( _src );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_AddEventSubscribersFrom(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.AddEventSubscribersFrom( _src );
		    ...
		    try {
                ...
                
                {
                    Spine.Skeleton _skeleton = (Spine.Skeleton)translator.GetObject(L, 2, typeof(Spine.Skeleton));
                        ...
                        var gen_ret = gen_to_be_invoked.Apply( _skeleton );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ApplyEventTimelinesOnly(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Spine.Skeleton _skeleton = (Spine.Skeleton)translator.GetObject(L, 2, typeof(Spine.Skeleton));
                        ...
                        var gen_ret = gen_to_be_invoked.ApplyEventTimelinesOnly( _skeleton );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _loop = LuaAPI.lua_toboolean(L, 4);
                        ...
                        var gen_ret = gen_to_be_invoked.SetAnimation( _trackIndex, _animationName, _loop );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<Spine.Animation>(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _loop = LuaAPI.lua_toboolean(L, 4);
                        ...
                        var gen_ret = gen_to_be_invoked.SetAnimation( _trackIndex, _animation, _loop );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 5&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)) 
                {
                    ...
                    float _delay = (float)LuaAPI.lua_tonumber(L, 5);
                        ...
                        var gen_ret = gen_to_be_invoked.AddAnimation( _trackIndex, _animationName, _loop, _delay );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 5&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<Spine.Animation>(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)) 
                {
                    ...
                    float _delay = (float)LuaAPI.lua_tonumber(L, 5);
                        ...
                        var gen_ret = gen_to_be_invoked.AddAnimation( _trackIndex, _animation, _loop, _delay );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _mixDuration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.SetEmptyAnimation( _trackIndex, _mixDuration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _delay = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        var gen_ret = gen_to_be_invoked.AddEmptyAnimation( _trackIndex, _mixDuration, _delay );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _trackIndex = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetCurrent( _trackIndex );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ClearListenerNotifications(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.ClearListenerNotifications(  );
        ...
        static int _s_set_Data(RealStatePtr L)
        {
		    try {
                ...
                Spine.AnimationState gen_to_be_invoked = (Spine.AnimationState)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.Data = (Spine.AnimationStateData)translator.GetObject(L, 2, typeof(Spine.AnimationStateData));
