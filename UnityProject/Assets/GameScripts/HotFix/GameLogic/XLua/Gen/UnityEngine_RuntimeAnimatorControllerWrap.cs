...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineRuntimeAnimatorControllerWrap 
    {
        ...
        {
            return LuaAPI.luaL_error(L, "UnityEngine.RuntimeAnimatorController does not have a constructor!");
        }
        ...
        static int _g_get_animationClips(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.RuntimeAnimatorController gen_to_be_invoked = (UnityEngine.RuntimeAnimatorController)translator.FastGetCSObj(L, 1);
