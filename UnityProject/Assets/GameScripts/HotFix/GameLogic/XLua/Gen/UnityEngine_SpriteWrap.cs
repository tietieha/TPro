...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineSpriteWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 7, 16, 0);
			
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetSecondaryTextureCount", _m_GetSecondaryTextureCount);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetSecondaryTextures", _m_GetSecondaryTextures);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetSecondaryTextureCount(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetSecondaryTextureCount(  );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetSecondaryTextures(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.SecondarySpriteTexture[] _secondaryTexture = (UnityEngine.SecondarySpriteTexture[])translator.GetObject(L, 2, typeof(UnityEngine.SecondarySpriteTexture[]));
                    
                        var gen_ret = gen_to_be_invoked.GetSecondaryTextures( _secondaryTexture );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
        ...
        static int _m_Create_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 9&& translator.Assignable<UnityEngine.Texture2D>(L, 1)&& translator.Assignable<UnityEngine.Rect>(L, 2)&& translator.Assignable<UnityEngine.Vector2>(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)&& translator.Assignable<UnityEngine.SpriteMeshType>(L, 6)&& translator.Assignable<UnityEngine.Vector4>(L, 7)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 8)&& translator.Assignable<UnityEngine.SecondarySpriteTexture[]>(L, 9)) 
                {
                    UnityEngine.Texture2D _texture = (UnityEngine.Texture2D)translator.GetObject(L, 1, typeof(UnityEngine.Texture2D));
                    UnityEngine.Rect _rect;translator.Get(L, 2, out _rect);
                    UnityEngine.Vector2 _pivot;translator.Get(L, 3, out _pivot);
                    ...
                    UnityEngine.Vector4 _border;translator.Get(L, 7, out _border);
                    bool _generateFallbackPhysicsShape = LuaAPI.lua_toboolean(L, 8);
                    UnityEngine.SecondarySpriteTexture[] _secondaryTextures = (UnityEngine.SecondarySpriteTexture[])translator.GetObject(L, 9, typeof(UnityEngine.SecondarySpriteTexture[]));
                    
                        var gen_ret = UnityEngine.Sprite.Create( _texture, _rect, _pivot, _pixelsPerUnit, _extrude, _meshType, _border, _generateFallbackPhysicsShape, _secondaryTextures );
                        translator.Push(L, gen_ret);
