...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineApplicationWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 22, 31, 3);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "memoryUsageChanged", _e_memoryUsageChanged);
            ...
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "exitCancellationToken", _g_get_exitCancellationToken);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_exitCancellationToken(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, UnityEngine.Application.exitCancellationToken);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_memoryUsageChanged(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
                UnityEngine.Application.MemoryUsageChangedCallback gen_delegate = translator.GetDelegate<UnityEngine.Application.MemoryUsageChangedCallback>(L, 2);
                if (gen_delegate == null) {
                    return LuaAPI.luaL_error(L, "#2 need UnityEngine.Application.MemoryUsageChangedCallback!");
                }
                
				
				if (gen_param_count == 2 && LuaAPI.xlua_is_eq_str(L, 1, "+")) {
					UnityEngine.Application.memoryUsageChanged += gen_delegate;
					return 0;
				} 
			...
			return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Application.memoryUsageChanged!");
        }
