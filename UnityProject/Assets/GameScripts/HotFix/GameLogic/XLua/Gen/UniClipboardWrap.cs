...
namespace XLua.CSObjectWrap
{
    ...
    public class UniClipboardWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UniClipboard);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UniClipboard constructor!");
        ...
        static int _m_GetText_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = UniClipboard.GetText(  );
