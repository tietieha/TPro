...
namespace XLua.CSObjectWrap
{
    ...
    public class MBattleRenderParticleTimeWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(M.Battle.Render.ParticleTime);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new M.Battle.Render.ParticleTime();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to M.Battle.Render.ParticleTime constructor!");
        ...
        static int _g_get_time(RealStatePtr L)
        {
		    try {
                ...
                M.Battle.Render.ParticleTime gen_to_be_invoked = (M.Battle.Render.ParticleTime)translator.FastGetCSObj(L, 1);
