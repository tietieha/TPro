...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAnimationWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 22, 7, 6);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "PlayReset", _m_PlayReset);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Reset", _m_Reset);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SimpleLastFrame", _m_SimpleLastFrame);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SimpleFirstFrame", _m_SimpleFirstFrame);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "RewindPlay", _m_RewindPlay);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetAnimationLengthByName", _m_GetAnimationLengthByName);
        ...
        static int _m_Play(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    gen_to_be_invoked.Play( _clipName, _progress );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_PlayReset(RealStatePtr L)
        {
		    try {
                ...
                {
                    string _clipName = LuaAPI.lua_tostring(L, 2);
                    bool _isReset = LuaAPI.lua_toboolean(L, 3);
                    
                    gen_to_be_invoked.PlayReset( _clipName, _isReset );
        ...
        static int _m_Reset(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.Reset( _clipName );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SimpleLastFrame(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SimpleLastFrame( _clipName );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SimpleFirstFrame(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SimpleFirstFrame( _clipName );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_RewindPlay(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.RewindPlay( _clipName );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetAnimationLengthByName(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    string _clipName = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetAnimationLengthByName( _clipName );
