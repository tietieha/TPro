...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineTransformWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "TransformDirectionLua", _m_TransformDirectionLua);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetFullHierarchyPath", _m_GetFullHierarchyPath);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "TransformPointEx", _m_TransformPointEx);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ObjectRelativeToParentPos", _m_ObjectRelativeToParentPos);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_TransformDirectionLua(RealStatePtr L)
        {
		    try {
                ...
                {
                    float _inputX = (float)LuaAPI.lua_tonumber(L, 2);
                    float _inputY = (float)LuaAPI.lua_tonumber(L, 3);
                    float _dirX;
                    float _dirY;
                    float _dirZ;
                    
                    gen_to_be_invoked.TransformDirectionLua( _inputX, _inputY, out _dirX, out _dirY, out _dirZ );
                    LuaAPI.lua_pushnumber(L, _dirX);
                        
                    LuaAPI.lua_pushnumber(L, _dirY);
                        
                    LuaAPI.lua_pushnumber(L, _dirZ);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetFullHierarchyPath(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetFullHierarchyPath(  );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_TransformPointEx(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    float _z = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        var gen_ret = gen_to_be_invoked.TransformPointEx( _x, _y, _z );
                        translator.PushUnityEngineVector3(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ObjectRelativeToParentPos(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    float _z = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        var gen_ret = gen_to_be_invoked.ObjectRelativeToParentPos( _x, _y, _z );
                        translator.PushUnityEngineVector3(L, gen_ret);
