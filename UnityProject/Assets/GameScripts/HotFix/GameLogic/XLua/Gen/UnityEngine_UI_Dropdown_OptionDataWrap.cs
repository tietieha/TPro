        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new UnityEngine.UI.Dropdown.OptionData();
				...
				if(LuaAPI.lua_gettop(L) == 2 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING))
				{
					...
					var gen_ret = new UnityEngine.UI.Dropdown.OptionData(_text);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<UnityEngine.Sprite>(L, 2))
				{
					...
					var gen_ret = new UnityEngine.UI.Dropdown.OptionData(_image);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 3 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING) && translator.Assignable<UnityEngine.Sprite>(L, 3))
				{
					...
					var gen_ret = new UnityEngine.UI.Dropdown.OptionData(_text, _image);
					translator.Push(L, gen_ret);
