...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineParticleSystemWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 20, 35, 3);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetParticleColor", _m_SetParticleColor);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetParticleColor(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetParticleColor( _color );
