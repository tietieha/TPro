...
namespace XLua.CSObjectWrap
{
    ...
    public class UIProgressBarWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UIProgressBar);
        ...
        static int _m_SetProgress(RealStatePtr L)
        {
		    try {
                ...
                UIProgressBar gen_to_be_invoked = (UIProgressBar)translator.FastGetCSObj(L, 1);
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetProgress( _progress );
