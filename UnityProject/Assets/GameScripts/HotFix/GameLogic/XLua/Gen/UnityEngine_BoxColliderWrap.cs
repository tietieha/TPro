...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineBoxColliderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "BoxColliderSizeEx", _m_BoxColliderSizeEx);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_BoxColliderSizeEx(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.BoxColliderSizeEx( _x, _y, _z );
