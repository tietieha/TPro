...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUIInputFieldWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 23, 36, 25);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetTextEx", _m_SetTextEx);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetAlignmentForArabic", _m_SetAlignmentForArabic);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetTextEx(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetTextEx( _content );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetAlignmentForArabic(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetAlignmentForArabic(  );
