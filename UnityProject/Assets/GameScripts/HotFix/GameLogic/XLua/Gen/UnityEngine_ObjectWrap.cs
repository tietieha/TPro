...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineObjectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 1, 6, 2, 2);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "IsNotNull", _m_IsNotNull);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_IsNotNull(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.IsNotNull(  );
                        LuaAPI.lua_pushboolean(L, gen_ret);
