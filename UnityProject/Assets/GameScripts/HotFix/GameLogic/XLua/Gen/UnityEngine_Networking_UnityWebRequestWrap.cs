...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineNetworkingUnityWebRequestWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "PostWwwForm", _m_PostWwwForm_xlua_st_);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_PostWwwForm_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    string _uri = LuaAPI.lua_tostring(L, 1);
                    string _form = LuaAPI.lua_tostring(L, 2);
                    
                        var gen_ret = UnityEngine.Networking.UnityWebRequest.PostWwwForm( _uri, _form );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Networking.UnityWebRequest.PostWwwForm!");
        ...
        static int _m_Post_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _contentType = LuaAPI.lua_tostring(L, 3);
                    
                        var gen_ret = UnityEngine.Networking.UnityWebRequest.Post( _uri, _postData, _contentType );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<System.Uri>(L, 1)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)) 
                {
                    System.Uri _uri = (System.Uri)translator.GetObject(L, 1, typeof(System.Uri));
                    string _postData = LuaAPI.lua_tostring(L, 2);
                    string _contentType = LuaAPI.lua_tostring(L, 3);
