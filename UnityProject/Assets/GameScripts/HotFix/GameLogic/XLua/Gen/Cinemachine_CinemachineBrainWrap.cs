...
namespace XLua.CSObjectWrap
{
    ...
    public class CinemachineCinemachineBrainWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 6, 17, 12);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "ControlledObject", _g_get_ControlledObject);
			...
			Utils.RegisterFunc(L, Utils.SETTER_IDX, "ControlledObject", _s_set_ControlledObject);
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "ActiveBlend", _s_set_ActiveBlend);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Cinemachine.CinemachineBrain();
        ...
        static int _m_GetSoloGUIColor_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = Cinemachine.CinemachineBrain.GetSoloGUIColor(  );
		    ...
		    try {
                ...
                
                {
                    ...
                    float _deltaTime = (float)LuaAPI.lua_tonumber(L, 6);
                        ...
                        var gen_ret = gen_to_be_invoked.SetCameraOverride( _overrideId, _camA, _camB, _weightB, _deltaTime );
		    ...
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<Cinemachine.ICinemachineCamera>(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    bool _dominantChildOnly = LuaAPI.lua_toboolean(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.IsLive( _vcam, _dominantChildOnly );
                        LuaAPI.lua_pushboolean(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_ControlledObject(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                Cinemachine.CinemachineBrain gen_to_be_invoked = (Cinemachine.CinemachineBrain)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.ControlledObject);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_ControlledObject(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                Cinemachine.CinemachineBrain gen_to_be_invoked = (Cinemachine.CinemachineBrain)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.ControlledObject = (UnityEngine.GameObject)translator.GetObject(L, 2, typeof(UnityEngine.GameObject));
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_ActiveBlend(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                Cinemachine.CinemachineBrain gen_to_be_invoked = (Cinemachine.CinemachineBrain)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.ActiveBlend = (Cinemachine.CinemachineBlend)translator.GetObject(L, 2, typeof(Cinemachine.CinemachineBlend));
