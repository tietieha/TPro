...
namespace XLua.CSObjectWrap
{
    ...
    public class CircleGuideMaskWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(CircleGuideMask);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetTarget3DGoWorldPos", _m_SetTarget3DGoWorldPos);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ResetMask", _m_ResetMask);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new CircleGuideMask();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to CircleGuideMask constructor!");
        ...
        static int _m_CalculateCenterDataByDimension(RealStatePtr L)
        {
		    try {
                ...
                CircleGuideMask gen_to_be_invoked = (CircleGuideMask)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetTarget3DGoWorldPos(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetTarget3DGoWorldPos( _worldPos );
        ...
        static int _m_SetTarget2DHollowSize(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetTarget2DHollowSize( _radius );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ResetMask(RealStatePtr L)
        {
		    try {
