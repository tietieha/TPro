		    ...
		    try {
                ...
                
                {
                    ushort _audioTrackIdx = (ushort)LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetAudioChannelCount( _audioTrackIdx );
		    ...
		    try {
                ...
                
                {
                    ushort _audioTrackIdx = (ushort)LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetAudioSampleRate( _audioTrackIdx );
		    ...
		    try {
                ...
                
                {
                    ushort _audioTrackIdx = (ushort)LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetAudioLanguage( _audioTrackIdx );
