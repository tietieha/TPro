...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEnginePlayablesPlayableDirectorWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 18, 9, 6);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "TrySetGenericBinding", _m_TrySetGenericBinding);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_TrySetGenericBinding(RealStatePtr L)
        {
		    try {
                ...
                {
                    string _timelineName = LuaAPI.lua_tostring(L, 2);
                    string _trackName = LuaAPI.lua_tostring(L, 3);
                    UnityEngine.GameObject _bindingObj = (UnityEngine.GameObject)translator.GetObject(L, 4, typeof(UnityEngine.GameObject));
                    
                        var gen_ret = gen_to_be_invoked.TrySetGenericBinding( _timelineName, _trackName, _bindingObj );
