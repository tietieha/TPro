...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineTrailRendererWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 11, 20, 19);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetVisiblePositions", _m_GetVisiblePositions);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "DOResize", _m_DOResize);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "DOTime", _m_DOTime);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetVisiblePositions(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Vector3[]>(L, 2)) 
                {
                    UnityEngine.Vector3[] _positions = (UnityEngine.Vector3[])translator.GetObject(L, 2, typeof(UnityEngine.Vector3[]));
                        ...
                        var gen_ret = gen_to_be_invoked.GetVisiblePositions( _positions );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.TrailRenderer.GetVisiblePositions!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DOResize(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        var gen_ret = gen_to_be_invoked.DOResize( _toStartWidth, _toEndWidth, _duration );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DOTime(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.DOTime( _endValue, _duration );
                        translator.Push(L, gen_ret);
