...
{
    public class PlatformMainThreadDispatcher : MonoBehaviour
    {
        ...
        private static PlatformMainThreadDispatcher _instance;
        ...
        public static PlatformMainThreadDispatcher Instance()
        {
            if (!Exists())
            {
                throw new Exception(
