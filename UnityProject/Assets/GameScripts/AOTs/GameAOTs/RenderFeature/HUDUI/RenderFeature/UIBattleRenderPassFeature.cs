    ...
    public class UIBattleRenderPassFeature : UWRenderFeature<UIBattleRenderPassFeature>
    {
        public class UIBattleHudPass : ScriptableRenderPass
        {
                ...
                ref RenderingData renderingData)
            {
                ...
                if (JumpWorldMesh != null && JumpWorldMesh.RealMesh != null &&
                    JumpWorldMesh.RealMaterial != null)
                    cmd.DrawMesh(JumpWorldMesh.RealMesh, Matrix4x4.identity,
                        JumpWorldMesh.RealMaterial);
        ...
        public override void UWAddRenderPasses(ScriptableRenderer renderer,
            ref RenderingData renderingData)
        {
