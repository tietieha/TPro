...
namespace HUDUI
{
    ...
    {
        void Serialize(HUDCSerialize ar);
    }
    ...
    public class HUDCSerialize
    {
        ...
        public HUDCSerialize(SerializeType arType)
        {
            m_arType = arType;
            m_arFile = new CSerialzieStream(arType);
            m_nVersion = 0;
        }
        public HUDCSerialize(SerializeType arType, byte[] buffer, int nBufSize)
        {
            m_arType = arType;
            m_arFile = new CSerialzieStream(arType, buffer, nBufSize);
            m_nVersion = 0;
        }
        public HUDCSerialize(SerializeType arType, string szFileName)
        {
            m_arType = arType;
        ...
        static HUDCSerialize s_readAr;
        public static HUDCSerialize ReadStream(byte[] buffer, int nBuffSize)
        {
            if (s_readAr == null)
                s_readAr = new HUDCSerialize(SerializeType.read, buffer, nBuffSize);
            else
                s_readAr.ResetStream(SerializeType.read, buffer, nBuffSize);
            return s_readAr;
        }
        static HUDCSerialize s_writeAr;
        public static HUDCSerialize WriteStream()
        {
            if (s_writeAr == null)
                s_writeAr = new HUDCSerialize(SerializeType.write);
            else
        ...
        public delegate void SerializeValue<_Ty>(HUDCSerialize ar, ref _Ty tValue);
        ...
        public delegate void SerializeArrayNode<_Ty>(HUDCSerialize ar, ref _Ty value);
        ...
        public delegate void SerializeIterator<_TyKey, _TyValue>(HUDCSerialize ar, ref _TyKey key, ref _TyValue value);
        ...
        //-----------------------------------------------
        //public static HUDCSerialize operator >>(HUDCSerialize ar, int nValue)
        //{
        //    return ar;
        //}
    };
