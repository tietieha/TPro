...
//            }
            ...
            case AnimationType.LocalMove:
                switch (targetType) {
                case TargetType.Transform:
                    tween = ((Transform)target).DOLocalMove(endValueV3, duration, optionalBool0);
                    break;
                case TargetType.RectTransform:
                    tween = ((RectTransform)target).DOLocalMove(endValueV3, duration, optionalBool0);
                    break;
                }
            ...
            case AnimationType.CameraRect:
                ...
                break;
            case AnimationType.AnchorMove:
                tween = ((RectTransform)target).DOAnchorPos(endValueV2, duration, optionalBool0);
                break;
            }
