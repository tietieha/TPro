...
namespace U3DExtends
{
    ...
    public class PathSaver
    {
        ...
        {
            return EditorPrefs.GetString("PathSaver_" + U3DExtends.UIEditorConfigure.ProjectUUID + "_" + type.ToString(),
                GeDefaultPath(type));
        }
        ...
        public void SetLastPath(PathType type, string path)
        {
            ...
            EditorPrefs.SetString("PathSaver_" + U3DExtends.UIEditorConfigure.ProjectUUID + "_" + type.ToString(), path);
        }
    }
}
#endif