...
namespace U3DExtends
{
    ...
    public class LayoutInfo : MonoBehaviour
    {
            ...
            get
            {
                for (int i = 0; i < transform.childCount; i++)
                {
                    ...
                    if (child.GetComponent<Decorate>() != null ||
                        (_viewNameLabel != null && _viewNameLabel.transform == child))
                        continue;
        ...
        public void ApplyConfig(string view_path)
        {
            ...
            string real_layout_pos_str =
                content.Substring(RealPosStartStr.Length, pos_end_index - RealPosStartStr.Length);
