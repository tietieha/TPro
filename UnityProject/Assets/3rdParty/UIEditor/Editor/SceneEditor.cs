...
namespace U3DExtends
{
    public class SceneEditor
    {
        ...
        static void Init()
        {
            ...
            if (UIEditorConfigure.IsEnableFastSelectImage)
        ...
        static void OnSelectChange()
        {
            ...
            if (arr != null && arr.Length > 0)
            {
                ...
                if (selectObj != null && (arr[0] is Sprite || arr[0] is Texture2D))
                {
                    ...
                    {
                        isImgWidget = true;
                        UIEditorHelper.SetImageByPath(assetPath, image, UIEditorConfigure.IsAutoSizeOnFastSelectImg);
                    }
        ...
        static void OnSceneGUI(SceneView sceneView)
        {
            ...
            if (UIEditorConfigure.IsEnableDragUIToScene && (Event.current.type == EventType.DragUpdated ||
            ...
            else if (e.type == EventType.KeyDown && UIEditorConfigure.IsMoveNodeByArrowKey)
            {
                ...
                foreach (var item in Selection.transforms)
                {
                    ...
                    if (trans != null)
                    {
                        ...
                        {
                            Vector3 newPos = new Vector3(trans.localPosition.x, trans.localPosition.y + 1,
                        ...
                        {
                            Vector3 newPos = new Vector3(trans.localPosition.x - 1, trans.localPosition.y,
                                trans.localPosition.z);
                            trans.localPosition = newPos;
                            is_handled = true;
                        }
                     ...
                     && sceneView.in2DMode
                     && UIEditorConfigure.IsShowSceneMenu)
            {
        ...
        static bool HandleDragAsset(SceneView sceneView, Object handleObj)
        {
            ...
            {
                GameObject new_obj = PrefabUtility.InstantiatePrefab(handleObj) as GameObject;
                if (new_obj != null)
                {
